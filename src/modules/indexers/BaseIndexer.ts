...
export abstract class BaseIndexer<Entity extends EntityYaml, EntityYaml, Index> implements IIndexer<Entity> {
  ...
  constructor(parser: IParser<Entity, EntityYaml>, settings: IAdapter<PluginSettings>, adapter: IAdapter<Index>) {
    this._parser = parser;
